"""
Django settings for creatipal_41678 project.
...
ROOT_URLCONF = 'creatipal_41678.urls'
...
WSGI_APPLICATION = 'creatipal_41678.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "creatipal_41678 API",
    "DESCRIPTION": "API documentation for creatipal_41678 App",
    "VERSION": "v1",
}
